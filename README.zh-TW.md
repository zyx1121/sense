...
- **會議模式** — 系統音訊裡沒有你自己的聲音，開會時逐字稿會少掉你這側；從選單列打開後 mic 持續錄，你的發言以「**我**」標進逐字稿、系統音訊維持對方那側。對方的不同說話者會在本機分離（FluidAudio LS-EEND 分人）標成「**對方 A / 對方 B**」。請戴耳機（尚無回音消除）
...
- 首次開會議模式會從 Hugging Face 下載分人 model（之後走本機快取）
